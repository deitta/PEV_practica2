...
public class CruceVarianteOX implements AlgoritmoCruce {
	public void cruce(Cromosoma[] pob, int tamPob, double probCruce) {
		...
		for (int i = 0; i < nSelCruce; i+=2) {
			...
			cruceVarianteOX(pob[selCruce[i]], pob[selCruce[i+1]], hijo1, hijo2);
	...
	private void cruceVarianteOX(Cromosoma padre1, Cromosoma padre2, Cromosoma hijo1, Cromosoma hijo2) {
