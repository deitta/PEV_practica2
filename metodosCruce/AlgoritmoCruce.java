...
public interface AlgoritmoCruce {
	public default void cruceBase(Cromosoma[] pob, int tamPob, double probCruce) {
	...
	public void cruce(Cromosoma cromosoma, Cromosoma cromosoma2, Cromosoma hijo1, Cromosoma hijo2);
}
